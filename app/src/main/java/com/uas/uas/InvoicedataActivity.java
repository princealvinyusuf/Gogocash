...
public class InvoicedataActivity extends AppCompatActivity {

    TextView txtHello2, txtHello3;
    private String no_hp, kuota;
    ...
    protected void onCreate(Bundle savedInstanceState) { // Membuat pembbentukan Activity
        ...
        setContentView(R.layout.activity_invoicedata);  // Menggunakan view dari layout activity home
        ...
        kuota = extras.getString(KEY_NAME3);
        txtHello2.setText(no_hp);
        txtHello3.setText(kuota);
