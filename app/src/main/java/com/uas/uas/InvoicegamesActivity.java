...
public class InvoicegamesActivity extends AppCompatActivity {

    TextView txtHello2, txtHello3;
    private String games, voucher;
    ...
    protected void onCreate(Bundle savedInstanceState) { // Membuat pembbentukan Activity
        ...
        setContentView(R.layout.activity_invoicegames);  // Menggunakan view dari layout activity home

        txtHello2 = (TextView) findViewById(R.id.txtHello2);
        txtHello3 = (TextView) findViewById(R.id.txtHello3);

        Bundle extras = getIntent().getExtras();
        games = extras.getString(KEY_NAME2);
        voucher = extras.getString(KEY_NAME3);
        txtHello2.setText(games);
        txtHello3.setText(voucher);
