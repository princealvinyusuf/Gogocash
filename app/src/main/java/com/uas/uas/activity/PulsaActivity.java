...
import com.uas.uas.InvoicepulsaActivity;
...
public class PulsaActivity extends AppCompatActivity {
    ...
    private static String URL_BAYAR = "http://192.168.43.209/android/transaksi/pulsa/bayar.php"; // Mendeklarasikan variabel URL_REGIST yang dipointkan ke "http://192.168.43.209/android/transaksi/register.php" yang bertipe data String dan bersifat private dimana nilai data tidak dapat dirubah (static)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_bayar.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                String mDenom = denom.getText().toString().trim();

                if (!mNo_hp.isEmpty() || !mDenom.isEmpty()){
                    Regist();
                }

                else {
                    no_hp.setError("Harap Masukkan Nomor Handphone");
                    denom.setError("Harap Masukkan Denom");
                }
            }
    ...
    private void Regist(){ // Method ini digunakan untuk melakukan serangkaian tindakan registrasi user
        ...
        final String denom = this.denom.getText().toString().trim();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_BAYAR, // Membuat variable stringRequest untuk mengirimkan data ke variable URL_REGIST yang terpoint ke "http://192.168.43.209"
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            if (success.equals("1")){ // Jika Sukses mengirimkan data maka
                                Toast.makeText(PulsaActivity.this, "Permintaan Sedang Diproses", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(PulsaActivity.this, InvoicepulsaActivity.class);
                                intent.putExtra(KEY_NAME2, no_hp);
                                intent.putExtra(KEY_NAME3, denom);
                            ...
                            e.printStackTrace();
                            Toast.makeText(PulsaActivity.this, "Permintaan Gagal Diproses " +e.toString(), Toast.LENGTH_SHORT).show();
                            loading.setVisibility(View.GONE);
                            btn_bayar.setVisibility(View.VISIBLE);
                        }
                    }
                ...
                new Response.ErrorListener() { //Jika gagal mengirimkan data karena kesalahan
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(PulsaActivity.this, "Permintaan Gagal Diproses " +error.toString(), Toast.LENGTH_SHORT).show();
                        loading.setVisibility(View.GONE);
                        btn_bayar.setVisibility(View.VISIBLE);
                    }
                })
    ...
    private void showEmployee(){
        ...
        try {
            ...
            for(int i = 0; i<result.length(); i++){
                ...
                String id = jo.getString(konfigurasi.TAG_HP);
                String name = jo.getString(konfigurasi.TAG_DENOM);

                HashMap<String,String> employees = new HashMap<>();
                employees.put(konfigurasi.TAG_HP,id);
                employees.put(konfigurasi.TAG_DENOM,name);
                list.add(employees);
            }
        ...
        ListAdapter adapter = new SimpleAdapter(
                PulsaActivity.this, list, R.layout.list_itempulsa,
                new String[]{konfigurasi.TAG_HP,konfigurasi.TAG_DENOM},
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(PulsaActivity.this,"Mengambil Data","Mohon Tunggu...",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequest(konfigurasi.URL_GET_PULSA);
                return s;
            }
        }
    ...
    private void getUserDetail(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_READ,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            progressDialog.dismiss();
                            Toast.makeText(PulsaActivity.this, "Error Reading Detail "+e.toString(), Toast.LENGTH_SHORT).show();
                        }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progressDialog.dismiss();
                        Toast.makeText(PulsaActivity.this, "Error Reading Detail "+error.toString(), Toast.LENGTH_SHORT).show();
