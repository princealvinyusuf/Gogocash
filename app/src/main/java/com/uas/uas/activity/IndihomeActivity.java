...
import com.uas.uas.DashboardActivity;
...
public class IndihomeActivity extends AppCompatActivity {
    ...
    private static String URL_BAYAR = "http://192.168.43.209/android/transaksi/indihome/bayar.php"; // Mendeklarasikan variabel URL_REGIST yang dipointkan ke "http://192.168.43.209/android/transaksi/register.php" yang bertipe data String dan bersifat private dimana nilai data tidak dapat dirubah (static)
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_BAYAR, // Membuat variable stringRequest untuk mengirimkan data ke variable URL_REGIST yang terpoint ke "http://192.168.43.209"
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            if (success.equals("1")){ // Jika Sukses mengirimkan data maka
                                Toast.makeText(IndihomeActivity.this, "Permintaan Sedang Diproses", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(IndihomeActivity.this, InvoiceActivity.class);
                            ...
                            e.printStackTrace();
                            Toast.makeText(IndihomeActivity.this, "Permintaan Gagal Diproses " +e.toString(), Toast.LENGTH_SHORT).show();
                            loading.setVisibility(View.GONE);
                            btn_bayar.setVisibility(View.VISIBLE);
                        }
                    }
                ...
                new Response.ErrorListener() { //Jika gagal mengirimkan data karena kesalahan
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(IndihomeActivity.this, "Permintaan Gagal Diproses " +error.toString(), Toast.LENGTH_SHORT).show();
                        loading.setVisibility(View.GONE);
                        btn_bayar.setVisibility(View.VISIBLE);
                    }
                })
    ...
    private void showEmployee(){
        ...
        try {
            ...
            for(int i = 0; i<result.length(); i++){
                ...
                employees.put(konfigurasi.TAG_IDP,id);
                list.add(employees);
            }
        ...
        ListAdapter adapter = new SimpleAdapter(
                IndihomeActivity.this, list, R.layout.list_itemindihome,
                new String[]{konfigurasi.TAG_IDP},
                new int[]{R.id.id});
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(IndihomeActivity.this,"Mengambil Data","Mohon Tunggu...",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequest(konfigurasi.URL_GET_INDIHOME);
                return s;
            }
        }
    ...
    private void getUserDetail(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_READ,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            progressDialog.dismiss();
                            Toast.makeText(IndihomeActivity.this, "Error Reading Detail "+e.toString(), Toast.LENGTH_SHORT).show();
                        }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progressDialog.dismiss();
                        Toast.makeText(IndihomeActivity.this, "Error Reading Detail "+error.toString(), Toast.LENGTH_SHORT).show();
