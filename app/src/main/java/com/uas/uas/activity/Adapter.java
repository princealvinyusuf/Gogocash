...
public class Adapter extends RecyclerView.Adapter<Adapter.MyViewHolder> implements Filterable {
    ...
    List<Notes> notes, notesFilter;
    private Context context;
    private RecyclerViewClickListener mListener;
    CustomFilter filter;

    public Adapter(List<Notes> notes, Context context, RecyclerViewClickListener listener) {
        this.notes = notes;
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.mName.setText(notes.get(position).getName());
        holder.mType.setText(notes.get(position).getDeskripsi());
        holder.mDate.setText(notes.get(position).getDate());
        ...
        final Boolean love = notes.get(position).getLove();
    ...
    public Filter getFilter() {
        if (filter==null) {
            filter=new CustomFilter((ArrayList<Notes>) notesFilter,this);
